    ...
    <div>
      <div className="checkbox-group">
        ...
        <Form.Check
          ...
          label="LUZ DE RÉ"
          checked={data.luzRe}
          onChange={(e) => updateFieldHandler("luzRe", e.target.checked)}
        />
        <Form.Check
          type="checkbox"
          id="luzFreio"
        ...
        <Form.Check
          ...
          onChange={(e) => updateFieldHandler("retrovisores", e.target.checked)}
        />
        <Form.Check
          type="checkbox"
          id="pneus"
          label="PNEUS"
          checked={data.pneus}
          onChange={(e) => updateFieldHandler("pneus", e.target.checked)}
        />
        <Form.Check
          type="checkbox"
          ...
          onChange={(e) => updateFieldHandler("avariasLateralBau", e.target.checked)}
        />
        <Form.Check
          type="checkbox"
          id="ruidosBarulhos"
          ...
          onChange={(e) => updateFieldHandler("ruidosBarulhos", e.target.checked)}
        />
      </div>
    </div>
  );
